...
from .models import Movie,IndustryChoices,GenerChoices,ArtistChoices,LanguagesChoices,CertificationChoices
...
#         Movie.objects.create(name=name,photo=photo,description=description,
#                              release_date=release_date,industry=industry,runtime=runtime,certification=certification,
#                              genre=genre,artists=artists,video=video,tags=tags)
...
class PlayMovie(View):
    ...
    def get(self,request,*args,**kwargs):
        ...
        if plan:
            ...
            messages.error(request,'You must subscribe before watching')
