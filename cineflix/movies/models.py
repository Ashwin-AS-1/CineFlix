...
class CertificationChoices(models.TextChoices):
    ...
    S='S','S'
class GenerChoices(models.TextChoices):

    ACTION = 'Action','Action'

    ROMANTIC ='Romantic','Romantic'

    THERILLER ='Threiller','Threiller'
...
class ArtistChoices(models.TextChoices):
    ...
    MAMMOOTY ='Mammooty','Mammooty'

    NIVINPOLY='Nivinpauly','Nivinpauly'
...
class Industry(BaseClass):
    ...
    class Meta :
        ...
        verbose_name_plural = 'Indusrtries'
