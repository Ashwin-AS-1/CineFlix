...
from subscriptions.models import SubscriptionPlans,UserSubscription
...
class RazorPayView(View):
    ...
    def get(self,request,*args,**kwargs):
        ...
        with transaction.atomic():
            ...
            user_subscription = UserSubscription.objects.create(profile=user,plan=plan)
            ...
            transcation_obj =Transaction.objects.create(user_subscription=user_subscription,rzp_order_id=rzp_order_id,amount=plan.amount)
...
class PaymentVerifyView(View):
    ...
    def post(self,request,*args,**kwargs):
        ...
        return redirect('razorpay',uuid=user_subscription.plan)